...
//子控制器-tab
    ...
    $rootScope.query = function () {
        ...
        if ($scope.type == "03") {
            ...
            $scope.data.startTime = "2017-01-01 13:29:27";
        ...
        $scope.rankListDataPromise = $http({
            ...
            data: {
                ...
                /*good*/
                "startTime": $scope.data.startTime == null?Date.parse(new Date()):$rootScope.tools.dateToTimeStamp13Bit($scope.data.startTime),
